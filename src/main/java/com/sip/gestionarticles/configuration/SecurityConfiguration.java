package com.sip.gestionarticles.configuration;
...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.
                ...
                .antMatchers("/contact/add").hasAnyAuthority("AGENT","SUPERADMIN")
                .antMatchers("/provider/list").hasAnyAuthority("AGENT", "SUPERADMIN")
                .antMatchers("/produit/**").hasAnyAuthority("ADMIN", "SUPERADMIN").anyRequest()
    ...
    public void configure(WebSecurity web) throws Exception {
        web
                .ignoring()
                .antMatchers("/uploads/**","/front/**", "/images/**", "/css2/**", "/back/**",
                        "/back/css/**", "/back/img/**","/back/js/**","/back/scss/**","/back/vendor/**");
    }
